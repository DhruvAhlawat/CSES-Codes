...
signed main()
{
    //question is equivalent to find minimum number of decreasing subsequences, covering all elements
    //therefore we can just find max decreasing subsequence
    //similar to the Collecting numbers
    FASTINOUT;
    int n;
    cin >> n;
    vector<int> a(n,0);
