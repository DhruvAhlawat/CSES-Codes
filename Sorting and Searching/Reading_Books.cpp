...
signed main()
{
    ...
    cout << ((2*m > sum)? 2*m: sum);
    //the total time taken is the sum of times + the waiting time by one of them
    //ideally they wouldn't need to wait and would just go move to the next book
