...
signed main()
{
    ...
    //so firstly, all subarrays of size k would have less than k+1 distinct values obviously
    //therefore counting all of them is easy
    //tricky part is counting subarrays that are greater than this
