...
//dont send n = 0 to this if we want the Mod to be applied
...
signed main()
{
    ...
    int n;
    cin >> n;
    //we do simple Matrix Exponentiation
    if(n == 0)
    {
        cout << 0 << endl;
        return 0;
    }
    vector<vector<int>> og = {{1,1},{1,0}};
    cout << MatrixExponentiation(og,n,MOD)[0][1] << endl;
}